/*!
 * express-useragent.js v1.0.8 (https://github.com/biggora/express-useragent/)
      ...
      return (
        ...
        (this.getBrowserVersion = function(a) {
          ...
          switch (this.Agent.browser) {
            case "Edge":
              if (this._Versions.Edge.test(a)) return RegExp.$1;
              break;
            case "PhantomJS":
              if (this._Versions.PhantomJS.test(a)) return RegExp.$1;
              break;
            case "Chrome":
              if (this._Versions.Chrome.test(a)) return RegExp.$1;
              break;
            case "Chromium":
              if (this._Versions.Chromium.test(a)) return RegExp.$1;
              break;
            case "Safari":
              if (this._Versions.Safari.test(a)) return RegExp.$1;
              break;
            case "Opera":
              ...
              break;
            case "Firefox":
              if (this._Versions.Firefox.test(a)) return RegExp.$1;
              break;
            case "WinJs":
              if (this._Versions.WinJs.test(a)) return RegExp.$1;
              break;
            case "IE":
              ...
              break;
            case "ps3":
              if (this._Versions.Ps3.test(a)) return RegExp.$1;
              break;
            case "psp":
              if (this._Versions.Psp.test(a)) return RegExp.$1;
              break;
            case "Amaya":
              if (this._Versions.Amaya.test(a)) return RegExp.$1;
              break;
            case "Epiphany":
              if (this._Versions.Epiphany.test(a)) return RegExp.$1;
              break;
            case "SeaMonkey":
              if (this._Versions.SeaMonkey.test(a)) return RegExp.$1;
              break;
            case "Flock":
              if (this._Versions.Flock.test(a)) return RegExp.$1;
              break;
            case "OmniWeb":
              if (this._Versions.OmniWeb.test(a)) return RegExp.$1;
              break;
            case "UCBrowser":
              if (this._Versions.UC.test(a)) return RegExp.$1;
              break;
            case "Facebook":
              if (this._Versions.Facebook.test(a)) return RegExp.$1;
              break;
            default:
              if (
        ...
        (this.getOS = function(a) {
          switch (!0) {
            ...
            case this._OS.OSXSierra.test(a):
        ...
        (this.testCompatibilityMode = function() {
          ...
          if (this.Agent.isIE && /Trident\/(\d)\.0/i.test(a.Agent.source)) {
            ...
            7 === c &&
              7 === b &&
              ((a.Agent.isIECompatibilityMode = !0), (a.Agent.version = 11)),
              7 === c &&
                6 === b &&
                ((a.Agent.isIECompatibilityMode = !0), (a.Agent.version = 10)),
              7 === c &&
                5 === b &&
                ((a.Agent.isIECompatibilityMode = !0), (a.Agent.version = 9)),
              7 === c &&
                4 === b &&
                ((a.Agent.isIECompatibilityMode = !0), (a.Agent.version = 8));
          }
        }),
        (this.testSilk = function() {
          ...
          return (
            /Silk-Accelerated=true/gi.test(a.Agent.source) &&
              (this.Agent.SilkAccelerated = !0),
            this.Agent.isSilk ? "Silk" : !1
          );
        }),
        ...
        (this.reset = function() {
          var a = this;
          for (var b in a.DefaultAgent) a.Agent[b] = a.DefaultAgent[b];
          return a;
        }),
        (this.testMobile = function() {
          ...
          switch (!0) {
            ...
            case a.Agent.isWindowsPhone:
              (a.Agent.isMobile = !0), (a.Agent.isDesktop = !1);
          }
          /mobile/i.test(a.Agent.source) &&
            ((a.Agent.isMobile = !0), (a.Agent.isDesktop = !1));
        }),
        ...
        (this.testBot = function() {
          ...
          b
            ? (a.Agent.isBot = b[1])
            : a.Agent.isAuthoritative ||
              (a.Agent.isBot = /bot/i.test(a.Agent.source));
        }),
        (this.testSmartTV = function() {
          var a = this,
            b = new RegExp(
              ...
              "gi"
            ).exec(a.Agent.source.toLowerCase());
        ...
        (this.testAndroidTablet = function() {
          ...
          a.Agent.isAndroid &&
            !/mobile/i.test(a.Agent.source) &&
            (a.Agent.isAndroidTablet = !0);
        }),
        (this.parse = function(a) {
          var b = new d();
          return (
            (b.Agent.source = a.replace(/^\s*/, "").replace(/\s*$/, "")),
